...
package com.alibaba.weex.extend.module.widget.picker.widget;
...
//                dy = dy + distanceY;
//                System.out.println("distanceY==:" + dy);
//                if(Math.abs(dy) > 100){
//                    scroller.forceFinished(true);
//                    clearMessages();
//                    break;
//                }
    ...
    private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            System.out.println("xxxxxxxxxxxxxxxxxxxxxxxxxxxlastScrollY:" + lastScrollY + "," + velocityY);
            setNextMessage(MESSAGE_SCROLL);
            return true;
        }
    };
